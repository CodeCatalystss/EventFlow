 ...
 * Component: Card
 * Description: Versatile card container with glassmorphism support.
  ...
  "rounded-xl border text-card-foreground",
  {
    variants: {
      variant: {
        ...
        elevated: "bg-card border-border shadow-medium",
        outline: "bg-transparent border-border",
        accent: "bg-card border-primary/20 shadow-soft",
        glass: "bg-white/5 backdrop-blur-xl border border-white/10 shadow-large",
      },
    },
    defaultVariants: {
      variant: "default",
